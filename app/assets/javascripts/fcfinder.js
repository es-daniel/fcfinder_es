;(function($){
    $.fn.fcFinder = function(opts) {
        ...
        var i18n = {
            ...
            access_not_content	    :	'Acceso deneagado, Administrador solo',
            bottom_file			    :	'{0} Archivo ( {1} )',
            load_directory	        :  	'Cargando Directorio',
            read_permission	        :	'Permiso de lectura',
            write_permission        :	'Permiso de escritura',
            read_write_permission	:	'Permiso de Lectura/Escritura',
            directory	            :	'Directorio',

            error   :
            {
                large_file  	        :	'Error: El archivo supera el tamaño permitido {0}',
                error_type	            :	'Tipos de archivos no permitidos:\n {0}.',
                load_error	            :	'Error de carga: "{0}".',
                select_file_error	    :	'Seleccione el error de archivo.',
                error_msg	            :	'Error inesperado',
                download_error	        :	'Error de descarga: "{0}" podría. \n Por favor, comprobar el nombre del archivo, puede haber un error de duplicado',
            ...
            dialog  :
            {
                info_h	                :	'Información',
                info_size	            :	'Tamaño:',
                info_addres	            :	'Dirección:',
                info_url	            :	'Link:',
                info_cdate          	:	'Creación:',
                info_mdate	            :	'Modificación:',
                info_file_permission	:	'Permisos:',
                ...
                settings_show_size	    :	'Mostrar tamaño de archivo',
                settings_show_date	    :	'Mostrar fecha de creación del archivo',
                sorter_h	            :	'Clasificación',
                sorter_name	            :	'Ordenar por nombre',
                sorter_size	            :	'Ordenar por tamaño',
                sorter_date	            :	'Ordenar por fecha',
                sorter_kind	            :	'Ordenar por tipo'
            },
            ...
            contextmenu :
            {
                ...
                file_copy	        :	'Copiar',
                file_cut	        :	'Cortar',
                file_duplicate	    :	'Duplicar',
                file_rename	        :	'Renombrar',
                file_delete	        :   'Eliminar',
                file_info	        :	'Información',
                wrapper_paste	    :	'Pegar',
                wrapper_list_view	:	'Vista de lista',
                wrapper_icon_view	:	'Vista de iconos',
                wrapper_upload	    :	'Subir archivo',
                wrapper_newfolder	:	'Nuevo directorio',
                wrapper_refresh	    :	'Refrescar',
                wrapper_show_size	:	'Mostrar / Ocultar Tamaño',
                wrapper_show_date	:	'Mostrar / Ocultar Fecha',
                wrapper_namesorter	:	'Ordenar por nombre',
                wrapper_sizesorter	:	'Ordenar por tamaño',
                wrapper_datesorter	:	'Ordenar por fecha',
                wrapper_kindsorter	:	'Ordenar por tipo'
            },

            widget_menu	:
            {
                up_folder	:	'Directorio superior',
                upload		:	'Subir',
                ...
                delete		:	'Eliminar',
                settings	:	'Ajustes',
                icon_view	:	'Vista de iconos',
                list_view	:	'Vista de lista',
                show_size	:	'Mostrar tamaño',
                show_date	:	'Mostrat fecha',
                sort		:	'Ordenar',
                name_sorter	:	'Ordenar por nombre',
                size_sorter	:	'Ordenar por tamaño',
                date_sorter	:	'Ordenar por fecha',
                kind_sorter	:	'Ordenar por tipo',
                about		:	'Acerca de'
            }
        };
